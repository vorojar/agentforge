...
export const POSTGRES_INDEXES = [
  ...
  `CREATE INDEX IF NOT EXISTS idx_api_keys_agent_created ON api_keys(agent_id, created_at)`,
  `CREATE INDEX IF NOT EXISTS idx_providers_workspace ON providers(workspace_id)`,
  `CREATE INDEX IF NOT EXISTS idx_providers_workspace_primary_enabled ON providers(workspace_id, is_primary, enabled)`,
  `CREATE INDEX IF NOT EXISTS idx_agents_workspace ON agents(workspace_id)`,
  `CREATE INDEX IF NOT EXISTS idx_agents_workspace_created ON agents(workspace_id, created_at)`,
  `CREATE INDEX IF NOT EXISTS idx_sessions_workspace ON sessions(workspace_id)`,
  `CREATE INDEX IF NOT EXISTS idx_sessions_workspace_updated ON sessions(workspace_id, updated_at)`,
  `CREATE INDEX IF NOT EXISTS idx_sessions_workspace_agent_updated ON sessions(workspace_id, agent_id, updated_at)`,
  `CREATE INDEX IF NOT EXISTS idx_usage_logs_workspace ON usage_logs(workspace_id, created_at)`,
  `CREATE INDEX IF NOT EXISTS idx_usage_logs_workspace_agent_created ON usage_logs(workspace_id, agent_id, created_at)`,
  `CREATE INDEX IF NOT EXISTS idx_usage_logs_workspace_model_created ON usage_logs(workspace_id, model, created_at)`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_http_tools_workspace_created ON http_tools(workspace_id, created_at)`,
  `CREATE INDEX IF NOT EXISTS idx_knowledge_bases_workspace ON knowledge_bases(workspace_id)`,
  `CREATE INDEX IF NOT EXISTS idx_knowledge_bases_workspace_created ON knowledge_bases(workspace_id, created_at)`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_proxy_usage_workspace_channel_created ON proxy_usage_logs(workspace_id, channel_id, created_at)`,
  `CREATE INDEX IF NOT EXISTS idx_proxy_usage_workspace_provider_created ON proxy_usage_logs(workspace_id, provider_id, created_at)`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_knowledge_chunks_kb_source ON knowledge_chunks(kb_id, source_name)`,
